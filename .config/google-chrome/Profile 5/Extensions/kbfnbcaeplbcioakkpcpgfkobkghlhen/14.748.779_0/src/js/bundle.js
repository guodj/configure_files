!function e(t, n, r) {
    ...
    41: [ function(e, t, n) {
        (function(e, n) {
            !function(n) {
                ...
                var L = Object.getPrototypeOf, P = L && L(L(m([])));
                P && P !== b && _.call(P, y) && (N = P);
    ...
    96: [ function(e, t, n) {
        ...
        t.exports = function(e, t, n, _, v, y, w) {
            ...
            }, T = t + " Iterator", j = v == h, S = !1, N = e.prototype, L = N[f] || N[m] || v && N[v], P = L || x(v), I = v ? j ? x("entries") : P : void 0, A = "Array" == t ? N.entries || L : L;
            if (A && (C = d(A.call(new e())), C !== Object.prototype && (u(C, T, !0), r || s(C, f) || a(C, f, b))), 
            j && L && L.name !== h && (S = !0, P = function() {
                return L.call(this);
            }), r && !w || !p && !S && N[f] || a(N, f, P), c[t] = P, c[T] = b, v) if (k = {
                values: j ? P : x(h),
                keys: y ? P : x(g),
                entries: I
    ...
    154: [ function(e, t, n) {
        ...
        var r = e("./_global"), o = e("./_has"), i = e("./_descriptors"), a = e("./_export"), s = e("./_redefine"), c = e("./_meta").KEY, l = e("./_fails"), u = e("./_shared"), d = e("./_set-to-string-tag"), f = e("./_uid"), p = e("./_wks"), m = e("./_wks-ext"), g = e("./_wks-define"), h = e("./_keyof"), b = e("./_enum-keys"), _ = e("./_is-array"), v = e("./_an-object"), y = e("./_to-iobject"), w = e("./_to-primitive"), k = e("./_property-desc"), E = e("./_object-create"), C = e("./_object-gopn-ext"), x = e("./_object-gopd"), T = e("./_object-dp"), j = e("./_object-keys"), S = x.f, N = T.f, L = C.f, P = r.Symbol, I = r.JSON, A = I && I.stringify, M = "prototype", R = p("_hidden"), O = p("toPrimitive"), D = {}.propertyIsEnumerable, F = u("symbol-registry"), B = u("symbols"), W = u("op-symbols"), z = Object[M], G = "function" == typeof P, U = r.QObject, H = !U || !U[M] || !U[M].findChild, V = i && l(function() {
            ...
            return e === z && K(W, t, n), v(e), t = w(t, !0), v(n), o(B, t) ? (n.enumerable ? (o(e, R) && e[R][t] && (e[R][t] = !1), 
            n = E(n, {
                enumerable: k(0, !1)
            ...
            return !(this === z && o(B, e) && !o(W, e)) && (!(t || !o(this, e) || !o(B, e) || o(this, R) && this[R][e]) || t);
        }, $ = function(e, t) {
            ...
            for (var t, n = L(y(e)), r = [], i = 0; n.length > i; ) o(B, t = n[i++]) || t == R || t == c || r.push(t);
            return r;
        }, ee = function(e) {
        ...
        G || (P = function() {
            ...
            var e = f(arguments.length > 0 ? arguments[0] : void 0), t = function(n) {
                this === z && t.call(W, n), o(this, R) && o(this[R], e) && (this[R][e] = !1), V(this, e, k(1, n));
            };
            return i && H && V(z, e, {
                configurable: !0,
                set: t
        ...
        }), P[M][O] || e("./_hide")(P[M], O, P[M].valueOf), d(P, "Symbol"), d(Math, "Math", !0), 
        d(r.JSON, "JSON", !0);
    }, {
        "./_an-object": 62,
        "./_descriptors": 77,
    ...
    176: [ function(e, t, n) {
        ...
        function a(e) {
            return u(e.page, e.user), P ? P.updateState(e) : void (P = _.Buttons((0, m["default"])({}, e, {
                app: L,
                document: document,
                actions: O
            })));
        ...
        var g = e("./console"), h = e("./state"), b = e("./util"), _ = e("./buttons"), v = e("./sites"), y = e("./external"), w = e("./failover"), k = e("./tracking"), E = e("./location"), C = e("./dictionary"), x = e("./timers"), T = e("lib/config"), j = 3e4, S = "init_without_bg_connection", N = E.getDomain(null, null), L = {}, P = void 0, I = void 0, A = void 0, M = setTimeout(o, j), R = h.createAndObserve(i), O = R.actions;
        l(), n.update = i;
    }, {
        "./buttons": 185,
        "./console": 204,
        ...
        function s(e, t) {
            function n() {
                te = le.createElement("grammarly-btn"), ne = f.findDOMNode(A()), r(), re = new y.Pos({
                    ...
                    initCondition: be
                }), re.on("update", N), re.on("change-state", L), Pe = w.BtnPath({
                    editorEl: $,
                    btnEl: ne,
                    padding: 15
                }), oe = k.Menu({
            ...
            function U() {
                G(), re && re.remove(), oe && oe.remove(), oe && oe.unbind(), p.unlisten(ne, "click", j), 
            ...
            var K = e.app, Q = e.user, X = e.page, J = e.connection, $ = e.field, Z = e.type, ee = e.actions, te = (e.disableIntersectionCheck, 
            void 0), ne = void 0, re = void 0, oe = void 0, ie = void 0, ae = void 0, se = void 0, ce = {
                visibility: "hidden"
            }, le = $.ownerDocument, ue = "iframe" == Z, de = ue ? a($) : $, fe = !1, pe = !J.online, me = void 0, ge = 0 == ($.value || $.textContent || "").trim().length, he = !1, be = !0, _e = !1, ve = !1, ye = !1, we = !1, ke = !1, Ee = !1, Ce = !1, xe = Q, Te = Q.anonymous, je = Q.premium, Se = Q.referral, Ne = X.referralWasClicked, Le = void 0, Pe = void 0, Ie = void 0, Ae = $, Me = m.pageStyles(le).getFixesForCurrentDomain(), Re = E.State(X.disabledFields, ee.toggleField), Oe = void 0, De = u.throttle(function() {}, 2e3), Fe = function(e) {
    ...
    187: [ function(e, t, n) {
        ...
        function o(e) {
            ...
            function o() {
                B.enabled ? (B.enabled = !1, R.disable(), P()) : (R.enable(), B.enabled = !0), y.fire("btn-disable-in-field", B.enabled), 
                x();
            }
            function i(e) {
                B = e, D = e.user, x();
            ...
            function C(e) {
                ...
                return e && (i -= e.clientWidth, o -= e.clientHeight / 2), o += r ? J : Q, i -= r ? X : K, 
            ...
            function N(e) {
                ...
                if (t && t != A) return P();
                if (p.hasClass(A, E.offline)) return P();
                var n = p.resolveEl(e.target, k.hoverMenu);
                return t || n == H ? e.target.classList.contains(E.btn_text) ? P() : void L() : P();
            }
            function L(e) {
            ...
            }, W = A.ownerDocument, z = W.createElement("div"), G = W.createElement("div"), U = p.transformProp(W), H = u.findDOMNode(x()), V = !1, q = !0, Y = void 0, K = -26, Q = 11, X = -13, J = 2;
            p.addClass(z, "gr-top-z-index"), p.addClass(z, "gr-top-zero"), z.setAttribute("tabindex", -1), 
    ...
    194: [ function(e, t, n) {
        ...
        function o(e) {
            ...
            function i() {
                ...
                if (h) return (0, u["default"])(t, L.btnCustomStyles ? L.btnCustomStyles(e, m) : {});
                n();
                var i = !e && x.resize ? -10 : 0, s = x.clientHeight < v, l = o(e, s) + r(e), d = e || s ? 0 : -7, f = e ? w : k, p = L.btnDiff && L.btnDiff(m, e) || [ 0, 0 ], g = (0, 
            ...
            var l = e.btnEl, m = e.sourceEl, g = e.custom, h = void 0 !== g && g, b = e.isTextarea, _ = void 0 !== b && b, v = 25, y = p.transitionEndEventName(), w = 22, k = 8, E = l.ownerDocument, C = p.transformProp(E), x = void 0, T = f.getPos(m), j = 0, S = 0, N = !1, L = d.pageStyles(E).getFixesForCurrentDomain(), P = function() {
                N = !1, n();
            };
    ...
    205: [ function(e, t, n) {
        ...
        function o() {
            ...
            function r(n, r) {
                ...
                } else P.enable(), P.show({
                    posEl: r.el,
                    text: "No definition found"
                });
                h.on(O, !0), b.timers.start(L);
            }
            function o() {
                var e = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0];
            ...
            function i() {
                I && I.remove(), h.off(O, !0), D.emit("hide"), P.disable(), P.hide(), I = null;
            }
            function a(e) {
                27 == u.keyCode(e) && i();
            }
            ...
            var N = C.createElement("div"), L = (0, c["default"])("DictionaryCard"), P = _.Tooltip({
    ...
    207: [ function(e, t, n) {
        ...
        n.css = S, n.setCustomCss = N, n.getParentByTag = L, n.getParentByData = P, n.resolveEl = I, 
        n.getParent = A, n.parentHasClass = M, n.getParentByDepth = R, n.isParent = O, n.insertAfter = D, 
        n.insertBefore = F, n.elementInDocument = B, n.runKeyEvent = W, n.docHidden = z, 
        n.visibilityEvent = G, n.transformProp = U, n.compStyle = H, n.classSelector = V, 
        n.selectorAll = q, n.nodeInTree = Y, n.watchNodeRemove = K, n.whichAnimationEndEvent = Q, 
        n.transitionEndEventName = X, n.addIframeCss = J, n.setGRAttributes = $, n.emitDomEvent = Z, 
    ...
    208: [ function(e, t, n) {
        ...
        function o(e) {
            function t() {
                ...
                t(_e, y.visibilityEvent(_e), H), t(_e, "grammarly:reset", P), me && t(_e.documentElement, "mousemove", s), 
    ...
    212: [ function(e, t, n) {
        ...
        var b = e("react"), _ = e("react-dom"), v = e("emitter"), y = e("../timers"), w = e("../util"), k = e("../window-events"), E = e("../tracking"), C = e("../position"), x = e("../dom"), T = e("./hint"), j = e("./tooltip"), S = e("./card-component"), N = e("../inline-cards"), L = {
            container: "_c4f153-container",
            flip: "_c4f153-flip",
            flipSyn: "_c4f153-flipSyn",
            card: "_c4f153-card",
            ...
            function t() {
                ...
                return p.show = function(e, t) {
                    return p.emit("show", e.id), p.updatePos(e, t), y.timers.start(P.id), p;
                }, p.hide = function() {
                    if (P.hint.visible) {
                        P.container.el.style.display = "none", p.setState({
                            animate: !1,
                            visible: !1,
                            match: {}
                        }), P.notfound.disable(), P.notfound.hide(), p.emit("hide", p.match), p.removeLoading(P.hint.currentEl);
                        y.timers.stop(P.id);
                        return p.match = null, P.container.el.style.display = "", p;
                    }
                }, p.animHide = function() {
                    return p.setState({
                        animate: !0
                    }), x.once.call(P.el, x.whichAnimationEndEvent(), p.hide), p;
                }, p.openEditor = function() {
                    p.removeLoading(P.hint.currentEl), p.emit("toeditor", p.match.editorId), p.hide();
                    ...
                    var t = e.target, n = e.clientX, r = e.clientY, o = e.detail, i = P.hint.currentEl, a = (x.parentHasClass(t, P.cls) || x.hasClass(t, P.cls)) && !x.hasClass(i, "g-selection-anim"), s = p.elementsFromPoint(n, r).some(function(e) {
                        return x.hasClass(e, P.cls);
                    });
                    return !(!s || !P.hint.visible || 1 != o) || (a ? i && i != t ? (P.hint.fastHide(), 
                    void p.removeLoading(i)) : (p.addLoading(t), !0) : void (!P.hint.visible && i && p.removeLoading(i)));
                }, p.addLoading = function(e) {
                    return !x.hasClass(e, P.pCls) && x.addClass(e, P.pCls);
                }, p.removeLoading = function(e) {
                    x.hasClass(e, P.pCls) && x.removeClass(e, P.pCls), x.hasClass(e, "g-selection-anim") && e.parentNode && e.parentNode.removeChild(e);
                }, p.showSynonyms = function(e) {
                    return e.animEl && 0 != e.animEl.getClientRects().length ? (P.hint.currentEl && p.hide(), 
                    P.hint.currentEl = e.animEl, 0 == e.synonyms.meanings.length ? (P.notfound.enable(), 
                    P.notfound.show({
                        posEl: e.animEl,
                        ...
                        visible: !0
                    })), P.hint.setVisible(!0), y.timers.start(P.id), p) : p;
                }, p.setOuterIframe = function(e) {
                    var t = e.contentDocument;
                    !e || t && e == P.iframe || (P.iframe = e, P.hint.setDocs(P.doc, t));
                }, p.experiments = l, p.isAnonymous = f, P = {
                    id: (0, a["default"])("GrammarCard"),
                    notfound: j.Tooltip({
                        cls: x.cs("gr-notfound-tooltip", I(p.experiments) && L.gr__tooltip_empty),
                        enabled: !1,
                        doc: r
                    }),
                    windowEvents: {
                    ...
                    cls: "gr_",
                    pCls: "gr-progress"
                }, P.container = p.render(P), P.el = _.findDOMNode(P.container.component), P.hint = new T.Hint({
                    doc: P.doc,
                    hint: P.el,
                    hideDelay: 500,
                    inTarget: p.inTarget,
                    ...
                    onshow: p.show,
                    onhide: p.hide
                }).bind(), p.hint = P.hint, k.on(P.windowEvents, !0), p;
            }
            return (0, h["default"])(t, e), (0, f["default"])(t, [ {
                ...
                key: "setState",
                value: function(e) {
                    P.container.component.setState(e);
                }
            }, {
                key: "setData",
                value: function(e) {
                ...
                value: function(e, t) {
                    ...
                    var r = C.getAbsRect(e, P.iframe, !0), i = C.posToRect(P.el, o(r, t));
                    i.rect.flip && (i.rect.top = i.rect.top + P.el.clientHeight), i.width = P.el.clientWidth, 
                    i.height = P.el.clientHeight, I(this.experiments) && E.call("gnar.track", "cardOpened", {
                ...
                value: function() {
                    ...
                    return x.renderReactWithParent(b.createElement(n, t), P.doc.documentElement, P.id, "grammarly-card");
                }
            }, {
                key: "remove",
                value: function() {
                    P.hint.unbind(), k.off(P.windowEvents, !0), P.container.remove();
                }
            } ]), t;
        }(w.createClass(v));
        n.Card = A;
    ...
    213: [ function(e, t, n) {
        ...
        function o(e) {
            ...
            function i(e, t) {
                n("off"), Y = o(t), Y.one("hide", function() {
                    n("on"), E.emitFocusedTab("focus-editor", q.editorId), x.logger.signinClose(C.timers.stop(z));
            ...
            function d() {
                if (G) {
                    var e = function() {
                        ...
                        var e = Q;
                        return Q = function(t) {
                            Q = e, O.refresh(), E.emitFocusedTab("after-refresh-dialog", t);
                        }, P(), {
                            v: void 0
                        };
                    }();
            ...
            function m(e) {
                ...
                return C.timers.start(z), q = t, D.anonymous ? i(n, D) : (O.activate(), void g(t));
            }
            function g(e) {
                ...
                j.listen(U, "click", l, !1), G = !0;
            }
            function h(e) {
                var t = e.action;
                "edit" === t && Q(e), "close" === t && P(), "initialized" === t && (S(e), setTimeout(function() {
            ...
            function P() {
                G && (G = !1, n("on"), U.style.opacity = "0", j.removeClass(U, "gr-_show"), j.unlisten(R.body, "keydown", M, !1), 
                j.unlisten(H, "click", l, !1), j.unlisten(U, "click", l, !1), O.send({
                    action: "hide"
                }), f(!1), u());
            }
            function A() {
                window === window.top && (E.off("show-dialog", m), E.off("hide-dialog", P), E.off("reset", r), 
                E.off("socket-server-iframe", y)), O.deactivate(), O.off("message", h), U.parentNode && U.parentNode.removeChild(U);
            }
            function M(e) {
                if (k.keyCode(e) === k.ESC_KEY && G) return e.stopPropagation(), e.preventDefault(), 
                P();
            }
            var R = e.doc, O = e.iframe, D = e.user, F = e.actions, B = F.updateSettings, W = F.incFixed, z = "Dialog", G = !1, U = void 0, H = void 0, V = void 0, q = void 0, Y = void 0, K = {
                show: m,
                hide: P,
                updateState: t,
                preActivate: p,
            ...
            O.on("message", h), window === window.top && (E.on("show-dialog", m), E.on("hide-dialog", P), 
        ...
        var b = e("lodash"), _ = e("react"), v = e("react-dom"), y = e("./iframe"), w = e("./signin-dialog"), k = e("../util"), E = e("../message"), C = e("../timers"), x = e("../tracking"), T = e("../location"), j = e("../dom"), S = "gr_-editor", N = "." + S, L = function(e) {
            return "." + S + "_" + e;
        }, P = function(e) {
            return S + "_" + e;
        }, I = function(e) {
    ...
    225: [ function(e, t, n) {
        ...
        var x = e("react"), T = e("react-dom"), j = e("lib/config"), S = e("lib/util"), N = e("lib/dom"), L = e("lib/message"), P = e("./signin-dialog"), I = e("lib/tracking"), A = e("emitter"), M = {
            signin_dialog: "_addf8f-signin_dialog",
            view_container: "_addf8f-view_container",
            view: "_addf8f-view",
            view_register: "_addf8f-view_register",
            ...
            function t(e) {
                ...
                return s.loading = !1, s.dialogComponent = null, s.formData = {
                    ...
                    I.fire("upgrade-after-register"), L.emitBackground("open-url", j.URLS.upgrade);
                }, s.onLogin = function() {
            ...
            return (0, w["default"])(t, e), (0, b["default"])(t, [ {
                ...
                value: function() {
                    var e = this.user;
                    this.checkContainer(), this.dialogComponent = T.render(x.createElement(P.SigninDialogComponent, {
    ...
    236: [ function(e, t, n) {
        ...
        function o(e) {
            ...
            function r(e) {
                try {
                    U.child.height = L.scrollHeight, D.scrollTop = L.scrollTop, clearTimeout(q), q = setTimeout(r, 100);
                } catch (e) {
            ...
            function i() {
                var e = {}, t = A.getComputedStyle(L, null);
                if (!t) return e;
                var n = function(e) {
            ...
            function h(e) {
                ...
                parseInt(e["margin-top"]) > 0 && m.css(L.parentNode, {
                    width: "auto",
                    overflow: "hidden"
                });
            ...
            function _() {
                var e = i();
                B || (h(e.src), G = L.previousElementSibling && "left" == m.css(L.previousElementSibling, "float"), 
                d.interval(_, 500), W || (W = !0, m.listen(L, X)), B = !0), U.parent.marginTop = o(U.parent.marginTop), 
                ...
                m.insertBefore(O, P)), M.matchPrefix && (t.className = M.matchPrefix), K.ghostHeight && (e.parent.height = K.ghostHeight(e.parent.height));
                var n = l.render(c.createElement(b, {
                    style: e,
                    attrs: t,
                    val: z
                }), O);
                D = l.findDOMNode(n), F = D.firstElementChild, D.contentEditable = !0, Q.clone = D, 
                Q.cloneVal = F, v(), y(), w(), 0 == L.offsetHeight ? j() : S(), Q.emit("render");
            }
            function v() {
                if (G) {
                    if (L.getBoundingClientRect().left == D.getBoundingClientRect().left && L.getBoundingClientRect().top == D.getBoundingClientRect().top) return G = !1;
            ...
            function y() {
                ...
                var t = p.getAbsRect(L), n = p.getAbsRect(D);
                if (n.left != t.left && e("left", "marginLeft", !1), n.top != t.top && e("top", "marginTop", !1), 
                D.clientWidth == L.clientWidth || d.isFF() ? n.width != t.width && (H.width = t.width) : n.width != t.width ? D.style.width = t.width : e("clientWidth", "width", !0), 
                d.isFF()) {
                    var r = m.css(L.parentNode, [ "margin-left", "margin-top", "position" ]);
            ...
            function w() {
                ...
                O && t(L) && (!e(O, L) && t(O) || m.insertBefore(O, P));
            }
            function k(e) {
            ...
            function j() {
                O.style.display = "none", d.isSafari() && (L.style.background = "", L.style.backgroundColor = ""), 
            ...
            function S() {
                B || (O.style.display = "", O.parentNode || m.insertBefore(O, P), _(), r());
            }
            function N() {
                T(), m.unlisten(L, X), j();
            }
            var L = e.el, P = f.isFacebookSite() ? L.parentNode : L, I = L.ownerDocument, A = I.defaultView, M = e.editor || {
                current: function() {
                    return [];
                }
            }, R = e.id, O = void 0, D = void 0, F = void 0, B = !1, W = void 0, z = "", G = !1, U = {
                parent: {},
                child: {}
            }, H = {}, V = void 0, q = void 0, Y = [], K = g.pageStyles(I).getFixesForCurrentDomain(), Q = s({
                render: _,
                getStyle: i,
                setText: a,
    ...
    237: [ function(e, t, n) {
        ...
        function r(e) {
            function t() {
                return B = D(z), B.on("exit", T), B.dom.insertGhost = w, F = s.Ghost({
                    id: L,
                    el: j,
                    editor: B
                }), z.gh = F, B.ghostarea = z, B._run = B.run, B.run = n, B;
            }
            function n() {
                r("on"), R = !0, P = d(), B._run(), F.show();
            }
            function r() {
            ...
            function b() {
                if ((0 == P.length && d().length > 0 || O) && (P = d(), O = !1), R) {
            ...
            function T() {
                r("off"), B && (B.off("exit", T), B.remove(), B = null), z.emit("exit"), j.removeAttribute("data-gramm"), 
                j.removeAttribute("data-txt_gramm_id"), F && (F.remove(), F = null);
            }
            var j = e.el, S = j.ownerDocument, N = S.defaultView, L = e.id, P = d(), I = !1, A = !1, M = void 0, R = !1, O = void 0, D = e.createEditor, F = void 0, B = void 0;
            j.setAttribute("data-gramm", ""), j.setAttribute("data-txt_gramm_id", L);
    ...
    257: [ function(e, t, n) {
        ...
        function a(e) {
            ...
            function r() {
                return [].concat((0, y["default"])(_e)).find(function(e) {
                    return "IFRAME" !== e.tagName && (ge === e || P.isParent(ge, e));
                });
            }
            function i() {
                var e = r();
            ...
            function V(e, t) {
                return o(e) && !G(e, t) && !z(e) && (P.isVisible(e) && D(e) || P.hasClass(e, "grammDemo"));
            }
            function q(e, t) {
            ...
            function X(e) {
                if (A.href = e.src, (0 !== e.src.indexOf("http") || ke.test(e.src)) && "about:blank" !== e.src && (!e.src || e.src.indexOf("javascript:") !== -1 || A.protocol === document.location.protocol && A.hostname === document.location.hostname && A.port === document.location.port) && !P.hasClass(e, N.baseCls)) {
                    var t = null;
                    try {
                        t = e.contentDocument;
                    } catch (n) {
            ...
            function J() {
                return [].concat((0, y["default"])((0, _["default"])(ve.querySelectorAll("iframe")))).filter(X);
            }
            function $(e) {
        ...
        var E = e("lodash"), C = e("emitter"), x = e("./config"), T = e("./sites"), j = e("./ghost/html-ghost-locator"), S = e("./window-events"), N = e("./elements/iframe"), L = e("./util"), P = e("./dom"), I = e("./location"), A = document.createElement("a"), M = 1e3, R = {
            draftjs: !1
        };
        n.PageFields = a;
    }, {
    ...
    263: [ function(e, t, n) {
        ...
        var T = w.getBrowser(), j = "other" === T ? "extension" : "extension_" + T, S = {
            ...
            action: "start",
            id: 0
        }, N = 12e4, L = function(e, t, n, r) {
            function i(e, t) {
                if (M(e, t), "disconnect" == e && R) return void (R = !1);
                var r = setTimeout(d, 5e3), i = P ? "socket-server-iframe" : "socket-server";
                return console.log("from ws", e, L, t, i), t && t.error && "not_authorized" == t.error ? p(j) : void _.emitTo(n, i, {
                    socketId: L,
                    event: e,
                    msg: t,
                    id: w.guid()
            ...
            var j = b(e), L = e.socketId, P = void 0, I = 0, A = !1, M = j.emit, R = !1, O = void 0;
    ...
    274: [ function(e, t, n) {
        ...
        function o() {
            var e = window.fetch.bind(window), t = y.LoggingImpl.DefaultLogAppender.createRootLogger("gnar", y.Logging.LogLevel.INFO, new y.LoggingImpl.GetFelogClient(m.URLS.newFelog, m.appName, m.getVersion(), m.ENV, e)), n = y.TimeSeriesImpl.MetricsStorage.createRoot("gnar", m.URLS.newFelog, e), r = new v.BackendStorage(e, h.GNAR.url), o = new v.ChromeCookieStorage(h.GNAR.url, h.GNAR.domain), i = new v.WebExtensionsCookieStorage(h.GNAR.url, h.GNAR.domain), a = new v.ContainerIdManager(g.isChrome() ? o : g.isFF() ? i : r, [ new v.CookieStorage(h.GNAR.domain), new v.LocalStorage(), new v.MemoryStorage() ], t.getLogger("containerId"), n.getCounter("containerId"), g.isChrome() ? 1e3 : 5e3);
            return new v.GnarClientImpl(h.GNAR.url, m.gnarAppName, h.getVersion(), e, a, t, n, (!0));
        }
        function i() {
                    ...
                    for (;;) switch (e.prev = e.next) {
                      case 0:
                        try {
                            ...
                            _.logger.gnarClientInitFail(t && t.message);
                        }
        ...
        var f = e("cookie"), p = e("../location"), m = e("../config"), g = e("../util"), h = e("../config"), b = e("./tracker"), _ = e("./logger"), v = e("@grammarly-npm/gnarclientweb"), y = e("@grammarly-npm/telemetry.ts");
    ...
    281: [ function(e, t, n) {
        ...
        n.on = (o = {}, (0, a["default"])(o, "activity-ping", function() {}), (0, a["default"])(o, "daily-ping", function(e, t) {
            return p(this, void 0, void 0, c["default"].mark(function n() {
                ...
                return c["default"].wrap(function(n) {
                    for (;;) switch (n.prev = n.next) {
                      ...
                      case 11:
                        b.logger.dailyPing(), m.prefs.set("pingDate", [ g.getNextPingDate(), l ].join("|"));
            ...
            h.call("gnar.track", "gbuttonClicked"), b.logger.gButtonClick();
            ...
            i !== t.id && (h.call("gnar.setUser", i), this["daily-ping"](i, r)), n && b.logger.sessionInvalidated(n, i !== t.id), 
            ...
            h.call("gnar.track", "definitionsToggled", e), b.logger.toggleExtensionDefs(e.enabled);
        }), (0, a["default"])(o, "change-grammar", function(e) {
            h.call("gnar.track", "checkingToggled", e), b.logger.toggleExtension(e.enabled);
    ...
    284: [ function(e, t, n) {
        ...
        function p() {
            Q.isWE() && (window.chrome.runtime.reload ? window.chrome.runtime.reload() : window.location.reload());
        }
        function m(e) {
            if (e.location) {
        ...
        var M = e("babel-runtime/regenerator"), R = r(M), O = e("babel-runtime/helpers/toConsumableArray"), D = r(O), F = e("babel-runtime/helpers/defineProperty"), B = r(F), W = e("babel-runtime/core-js/object/assign"), z = r(W), G = e("babel-runtime/core-js/object/keys"), U = r(G), H = e("babel-runtime/core-js/promise"), V = r(H), q = function(e, t, n, r) {
        ...
        var Y = e("lodash"), K = e("non-crypto-hash"), Q = e("./newConfig"), X = e("./newConfig");
        n.isTestsMode = X.isTestsMode, n.getBrowser = X.getBrowser, n.isBg = X.isBg, n.isBgOrPopup = X.isBgOrPopup, 
        n.isSafariSettingsPopup = X.isSafariSettingsPopup, n.isChrome = X.isChrome, n.isFF = X.isFF, 
        n.isPopup = X.isPopup, n.isSafari = X.isSafari, n.isSafari8 = X.isSafari8, n.isWE = X.isWE, 
        n.isWindows = X.isWindows, n.isGrammarlyEmail = o, n.chromeBgError = i, n.isFunction = a, 
        ...
        n.createChannel = N, n.normalizedHashCode = L, n.keyCode = P, n.SECOND = 1e3, n.MINUTE = 60 * n.SECOND, 
